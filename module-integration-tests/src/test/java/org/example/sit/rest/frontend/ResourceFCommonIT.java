 ...
 */
class ResourceFCommonIT extends RestResourceTestFactory {
   @BeforeAll
   public static void initRequestSpecification() {
      initRequestSpecifications(PATH_REST_FRONTEND_BASE + PATH_REST_FRONTEND_RESOURCE_F);
   }
   ...
   void test_RedirectFromHttpToHttps() {
      ...
      .then()
            ...
            .assertThat().header(HttpHeaders.LOCATION, startsWith("https"))
